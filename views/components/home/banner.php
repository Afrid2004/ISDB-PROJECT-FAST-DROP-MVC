                ...
                <div
                  ...
                  <div class="container">
                    <div class="w-full max-w-3xl">
                      <div class="px-4 py-1 border border-white w-fit text-white rounded-4xl mb-3">
                        <p class="uppercase">logistic transportation</p>
                      </div>
                      <div class="mb-5 md:mb-10">
                        <h1 class="text-5xl md:text-7xl font-bold text-white leading-15 md:leading-25 roboto">
