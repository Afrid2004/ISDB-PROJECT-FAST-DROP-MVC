...
?>
<div class="bg-gradient-to-r from-primary to-hover py-20 pt-30">
...
<div class="py-16 bg-gray-50">
  <div class="container">
    <div class="bg-white rounded-2xl shadow-lg border border-gray-200 p-8">
      ...
      <form method="GET">
        <div class="flex flex-col lg:flex-row gap-4">
          <input type="text" value="<?php echo strtoupper(trim($_GET['id'] ?? "")) ?>" name="id"
            placeholder="Enter Tracking ID (Example: FD-260714344243)"
            class="w-full border border-gray-300 rounded-xl px-5 py-4 outline-none focus:border-primary transition duration-200 text-secondary uppercase">
          <button type="submit"
    ...
    <?php elseif (!empty($trackingId) && empty($data)): ?>
      <div class="mt-10 bg-white rounded-2xl shadow-lg border border-gray-200 p-12 text-center">
        ...
        <p class="text-gray mt-3">
          We couldn't find any parcel with this tracking ID.
