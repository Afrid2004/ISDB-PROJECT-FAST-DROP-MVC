...
<div>
  <div class="grid grid-cols-12 gap-5">
    ...
    <div class="col-span-12 lg:col-span-6 flex flex-col">
      ...
      <div class="flex flex-col gap-2 bg-black/30 p-4 border border-gray-500/30 h-full">
        <div>
    ...
    <div class="col-span-12 lg:col-span-6 flex flex-col">
      ...
      <div class="flex flex-col gap-3 bg-black/30 p-4 border border-gray-500/30 h-full">
    ...
    <div class="col-span-12 lg:col-span-6 flex flex-col">
      ...
      <div class="flex flex-col gap-2 bg-black/30 p-4 border border-gray-500/30 h-full">
        <div class="text-white text-lg"><?php echo $parcelData->note ? $parcelData->note : "No additional note."; ?>
        </div>
    ...
    <div class="col-span-12 lg:col-span-6 flex flex-col">
      ...
      <div class="flex flex-col gap-2 bg-black/30 p-4 border border-gray-500/30 h-full">
        <?php if ($parcelData->assigned_rider_id): ?>
        <div class="text-white text-lg flex flex-col gap-2">
          <p>Assigned Rider ID : <?php echo $parcelData->assigned_rider_id ?></p>
          <p>Rider Name : <?php echo $parcelData->rider_name ?></p>
          <p>Rider Email : <?php echo $parcelData->rider_email ?></p>
          <p>Rider Phone : <?php echo $parcelData->rider_phone ?></p>
          <p>Vehicle Type : <?php echo ucfirst($parcelData->vehicle_type) ?></p>
        </div>
        <?php else: ?>
        <p class="text-white">No rider assigned yet.</p>
        <?php endif ?>
      </div>
    </div>
  </div>
