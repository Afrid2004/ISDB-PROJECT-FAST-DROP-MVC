                                ...
                                <tr
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex flex-col gap-2">
                                            <a href="<?php echo $base_url ?>/dashboard/approverider?id=<?php echo $data->id ?>" class="px-3 flex items-center gap-1 py-2 rounded bg-lime-500/20 text-lime-400 hover:bg-lime-500/30 active:bg-lime-500/20 cursor-pointer justify-center">
                                                <i class="fa-solid fa-check text-xs"></i> Approve
                                            </a>
                                            <a href="<?php echo ($data->status == 'declined') ? 'javascript:void(0)' : $base_url . '/dashboard/declinerider?id=' . $data->id; ?>" class="px-3 flex items-center gap-1 py-2 rounded justify-center <?php echo ($data->status == 'declined')? 'bg-gray-500/30 text-gray-500 cursor-not-allowed pointer-events-none': 'bg-red-500/20 text-red-400 hover:bg-red-500/30 active:bg-red-500/20 cursor-pointer' ?>">
