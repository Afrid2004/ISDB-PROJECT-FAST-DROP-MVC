<div class="flex flex-col gap-1">
    ...
    <div>
        <a class="block" href="<?php echo $base_url ?>/dashboard">
            <div
                class="flex items-center gap-2 text-white/70 hover:text-white p-3 hover:bg-white/20 duration-150 text-lg leading-none">
    ...
    <div>
        <div class="submenu_toggler">
            ...
            <div class="max-h-0 opacity-0 [.active_&]:py-3 [.active_&]:max-h-100 [.active_&]:opacity-100 duration-150 overflow-hidden">
