<div>
  <div>
    <div class="mb-3 flex items-center justify-between gap-2">
      <h2 class="text-white font-medium text-2xl ">All Assigned Parcels</h2>
    </div>
    <div>
                ...
                <tr
                  ...
                  <td class="px-6 py-4">
                    <div class="flex flex-col gap-2">
                      ...
                      <?php if ($data->parcel_status == 'assigned'): ?>
                        <button data-parcelid="<?php echo $data->id ?>" data-riderid="<?php echo $data->assigned_rider_id ?>"
                          class="viewParcelBtn accept_parcel px-3 flex items-center gap-1 py-2 rounded bg-lime-500/20 text-lime-400 hover:bg-lime-500/30 active:bg-lime-500/20 cursor-pointer justify-center">
                          <i class="fa-solid fa-check text-sm"></i> Accept</button>
                        <button data-parcelid="<?php echo $data->id ?>" data-riderid="<?php echo $data->assigned_rider_id ?>"
                          class="viewParcelBtn reject_parcel px-3 flex items-center gap-1 py-2 rounded bg-red-500/20 text-red-400 hover:bg-red-500/30 active:bg-red-500/20 cursor-pointer justify-center"><i
                            class="fa-solid fa-xmark text-sm"></i> Reject</button>
                      <?php endif ?>
                    </div>
                  </td>
                  <td class="px-6 py-4">
